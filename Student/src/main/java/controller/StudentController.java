...
public class StudentController {
	...
	public Student createEmployee(@RequestBody Employee employee) {
	...
	public ResponseEntity<Student> updateEmployee(@PathVariable Long id, @RequestBody Employee employeeDetails){
		Student employee = employeeRepository.findById(id)
				.orElseThrow(() -> new ResourceNotFoundException("Employee not exist with id :" + id));
